...
export const IdoHeader = function () {
  ...
  return [
    ...
    { name: i18n.home.topList.currentPrice, key: "price", sort: true, width: "w-27.5" },
    { name: i18n.home.topList.nowCurrent, key: "currentRoi", sort: true, width: "w-27.5" },
    { name: i18n.home.topList.idoAth, key: "athRoi", sort: true, width: "w-27.5" },
