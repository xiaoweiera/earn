            ...
            <table class="table-my my-4">
              <thead>
                <tr class="border-tb">
                  ...
                  <td>
                    <uiSort class="sort" :sort="false" :sort-data="params" key-name="name" name="Project Name" @change="sort" />
                  </td>
                  <td class="w-45">
                    <uiSort class="sort justify-center" :sort-data="params" key-name="project__categories" name="Type" @change="sort" />
                  </td>
                  <td class="w-20">
                    <uiSort class="sort justify-center" :sort-data="params" key-name="stage_name" name="Round" @change="sort" />
                  </td>
                  <td class="w-20">
