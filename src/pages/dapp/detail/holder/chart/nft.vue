  ...
  <div>
    ...
    <div class="w-full mt-7">
      ...
      <div :key="dataKey" class="w-full h-114.5 mt-2.5">
        <ui-echart-dapp :id="data.id" :legend="LegendDirection.custom" custom-class="h-100" :start="getData(range)" unit="DAY" :fields="['volumeWithWhales', 'volumeWithBlueChipHolder']">
          <!--展示自定义图列-->
