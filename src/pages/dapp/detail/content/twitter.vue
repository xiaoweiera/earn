...
<template>
  <div>
    <div v-if="name" class="relative">
      <iframe :src="getUrl(name)" allowfullscreen="" class="h-200 w-full rounded-md border border-solid border-global-highTitle border-opacity-6" frameborder="0" @load="onLoad"></iframe>
