...
import { valueFormat, toNumberFormat } from 'src/utils/convert/to'
...
<template>
  <div v-if="data">
    <div class="w-full h-39.5 px-4 pt-7 text-global-white">
      <!-- 项目名称 -->
      <div class="flex items-center min-h-6 h-9">
        <span class="max-w-full inline-flex items-center h-full text-kd16px16px text-global-white font-semibold font-kdBarlow">
          {{ data.name }}
