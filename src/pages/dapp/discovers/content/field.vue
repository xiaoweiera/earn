...
<template>
  <div>
    <div class="w-full md:w-50 flex md:ml-3 relative">
      <input class="w-full md:w-50 h-8 text-kd14px18px text-global-highTitle text-opacity-85 bg-global-white md:bg-global-topBg border border-global-highTitle border-opacity-4 rounded-md" v-model="searchval" :placeholder="title" type="text">
