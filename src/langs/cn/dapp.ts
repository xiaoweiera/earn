...
export default {
  ...
  activity: {
    ...
    backgroundTip:
      "此次，KingData 鲸鱼奖将以6大赛道进行展开，分别为：NFT 新锐榜、 GameFi 新锐榜、 Dao 新锐榜、 基础设施新锐榜、 公链新锐榜、DEX 新锐榜。评选出2021年各个赛道最佳、最具潜力的明星项目，一方面；为投资者总结市场，找到更好的投资标地以及行业趋势，另一方面；助力明星项目在区块链产业中勇往直前，最终成为如蓝鲸一般的“行业巨兽”。",
    backgroundTips: "",
    participation: "参与方式：",
